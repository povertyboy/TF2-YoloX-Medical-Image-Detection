...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = 'model_data\yolox_l.h5'  #  'model_data\yolox_s.h5'
    #------------------------------------------------------#
    ...
    if True:
        ...
        if eager:
            ...
            model.fit_generator(
                ...
                workers             = num_workers,
                # callbacks           = [logging, checkpoint, reduce_lr, loss_history]
    ...
    if True:
        ...
        if eager:
            ...
            model.fit_generator(
                ...
                workers             = num_workers,
                # callbacks           = [logging, checkpoint, reduce_lr, loss_history]
                callbacks = [logging, checkpoint, reduce_lr, early_stopping, loss_history] # 先暂时关闭早停
            )
